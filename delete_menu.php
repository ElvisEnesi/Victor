...
<body>
    <section class="must_know">
        ...
        <ol>
        <form action="delete_menu_logic.php" method="post">
            <input type="hidden" name="menu_del" value="<?= $menu['id'] ?>">
            <button type="submit" name="submit">Yes</button>
        </form>
        <button onclick="window.location.href='manage_menu.php'">No</button>
        </ol>
    </section>
